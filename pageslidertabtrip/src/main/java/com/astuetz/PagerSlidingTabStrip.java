...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider &&  pager.getAdapter().getPageTitle(i)!=null) {
				addIconTextTab(i,((IconTabProvider) pager.getAdapter()).getPageIconResId(i),pager.getAdapter().getPageTitle(i).toString());
